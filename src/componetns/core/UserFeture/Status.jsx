...
import ViewOrAddStatus from './ViewOrAddStatus';
import StatusModal from './StatusModal';

const Status = ({setStatus,setAnuj,userData,contact}) => {
  ...
  return (
    <div className='w-full h-full min-w-[340px] border border-black flex items-center justify-center transition-all '>
                  ...
                  :   <div className='w-full h-full bg-slate-700'>
                        ...
                        <div className='flex flex-row gap-2 w-full items-center p-2 border border-black '>
                         <div className='relative'>
                           <label>
                           <img src={userData.image} className='cursor-pointer h-[50px] w-[50px] rounded-full '/>
                         ...
                         <div onClick={() => handleViewStatus(userData)}
            ...
            {
                statusFile && <ViewOrAddStatus fileUrl={statusImageUrl ? statusImageUrl : statusVidioUrl} 
